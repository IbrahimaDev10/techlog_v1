...
$insertChauf = $bdd->prepare("INSERT INTO chauffeur(nom_chauffeur,n_permis,num_telephone) VALUES(?,?,?)");

$insertChauf->bindParam(1,$chauffeur);
$insertChauf->bindParam(2,$permis);
$insertChauf->bindParam(3,$tel);
...
$rowchauffeur=$bdd->query("select * from chauffeur 
	 order by id_chauffeur desc limit 5 ");
	...
	<div class="content-start transition" style="background-image: url('../images/bg_page.jpg'); background-repeat:no-repeat; background-size: 100%;  margin: 0px; border: none; border-radius: 0px;">
		<div class="container-fluid dashboard">
			...
			<div class="container-fluid" >
				<div class="row">
					<center>
			<h3 class="ajout_dis" style="color: white;">INSERTION DES CHAUFEURS</h3>
			</center>
  ...
  <div class="modal-dialog">
     <div class="modal-content" style=" border: solid; border-color:rgb(0,141,202); ">
            <div class="modal-header" style="">
              <center>
              	<h3 class="modal-title fs-10 text-white text-center" id="exampleModalLabel " style="text-align:center; ">AJOUT CHAUFFEUR</h3></center>
              	<center>
...
<div class="form-group position-relative has-icon-left mb-5">
  ...
  <input type="text" class="form-control"  id="exampleFormControlInput1" placeholder="chauffeur" name="CHAUFFEUR"><br>

     
  <input type="text" class="form-control"  id="exampleFormControlInput1" placeholder="numero permis" name="PERMIS"><br>

      
  <input type="text" class="form-control" id="telephoneInput"  placeholder="TELEPHONE" name="tel"  data-inputmask="'mask': '99 999 99 99'"><br>
 ...
 <table  class='table table-hover table-bordered table-striped'  border='2'  >
 	...
 	<th style="border-color:white;" scope="col" ></th>
                       <tr style="color:white; font-weight: bold; background: rgb(0,141,202);border-color: white; text-align: center;" border='5' >
                     	 ...
                     	 <th style="border-color:white;" scope="col" >NOM CHAUFFEUR</th>
                       
                           <th style="border-color:white;" scope="col" >PERMIS</th>
                             <th style="border-color:white;" scope="col" >TELEPHONE</th>
                                   ...
                                   <?php while($row=$rowchauffeur->fetch()){ ?>
                                   
                          <tr style="text-align:center;" border='5' id="<?php echo $row['id_chauffeur'] ?>">
                          	
                                 <td id="coltd" ><?php echo $row['nom_chauffeur']; ?></td>
                                <td id="coltd" ><?php echo $row['n_permis'];?></td>
                              <td id="coltd" ><?php echo $row['num_telephone']; ?> </td>
