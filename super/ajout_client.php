	...
	<div class="content-start transition" style="background-image: url('../images/bg_page.jpg'); background-repeat:no-repeat; background-size: 100%;  margin: 0px; border: none; border-radius: 0px;">
		<div class="container-fluid dashboard">
			...
			<div class="container-fluid" >
				<div class="row">
					<center>
			<h3 class="ajout_dis" style="color: white;">INSERTION RECEPTIONNAIRE</h3>
			</center>
  ...
  <div class="modal-dialog">
     <div class="modal-content" style=" border: solid; border-color:rgb(0,141,202); ">
            <div class="modal-header" style="">
              <center>
              	<h3 class="modal-title fs-10 text-white text-center" id="exampleModalLabel " style="text-align:center;   ">AJOUT RECEPTIONNAIRE</h3></center>
              	<center>
...
<div class="form-group position-relative has-icon-left mb-5">
  ...
  <input type="text"   placeholder="CODE PPM" name="code"><br>
  <input type="text"   placeholder="ADRESSE" name="adresse"><br>
  <input type="text"     placeholder="TELEPHONE" name="telephone" oninput="formatTelephone()" ><br>
 ...
 <table  class='table table-hover table-bordered table-striped'  border='2'  >
 	...
 	<th style="border-color:white;" scope="col" ></th>
                       <tr style="color:white; font-weight: bold; background: rgb(0,141,202); font-family: montserrat; border-color: white; text-align: center;" border='5' >
                     	 <th style="border-color:white;" scope="col" ></th>
                     	  <th style="border-color:white;" scope="col" >RECEPTIONNAIRE</th>
 ...
 <?php 
      ...
      $cal=$calculLigne->fetch();              	
                          ...
                          <tr style="text-align:center;" border='5' id="<?php echo $row['id'] ?>">
                          	<td id="coltd" ><span style="color: red; margin-left: 0px; " >	<?php echo  $cal['count(client)']; ?></span> </td>
                          	<td id="coltd">	<?php echo  $row['client']; ?> </td>
                          	<td id="coltd">	<?php echo  $row['code_ppm_client']; ?> </td>
                          	<td id="coltd">	<?php echo  $row['adresse_client']; ?> </td>
                          	<td id="coltd">	<?php echo  $row['tel_client']; ?> </td>
                          	
                          	<td id="coltd">	<?php echo  $row['email_client']; ?> </td>
                             ...
                             <td id="coltd">
                          	...
                          	<a class="fabtn" type="" name="modify"  href="modifier_client.php?id=<?php echo $row['id']; ?>"       id="btnbtn" > <i class="fa fa-edit " ></i></a></td>         
                              </tr>
                      <?php } ?>	
