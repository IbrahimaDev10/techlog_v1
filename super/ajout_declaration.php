...
if(isset($_POST['ajout_declare']) and isset($_GET['m'])){
	if(!empty($_POST['bl'])  and !empty($_POST['des_douaniere']) and !empty($_POST['numero']) and !empty($_POST['poids']) and !empty($_POST['statut_douanier'])){
		//$nav=$_POST['navire'];
        ...
        $reelle="true";
			 ...
			 $insertDispat= $bdd->prepare("INSERT INTO transit_reelle(destination_douaniere,id_declaration_reelle,poids_declarer,statut_douaniere,id_bl,id_trans_navire) VALUES(?,?,?,?,?,?)");
		 ...
		 $insertDispat->bindParam(2,$numero);
		 $insertDispat->bindParam(3,$poids);
		 $insertDispat->bindParam(4,$statut);
		 $insertDispat->bindParam(5,$bl);
		 $insertDispat->bindParam(6,$_GET['m']);
...
<div class="form-group position-relative has-icon-left mb-5">
	...
	<?php           
        ...
        $connaissement->bindParam(1,$_GET['m']);
       
        $connaissement->execute(); ?>

        <select name="bl" style="max-width: 200px;">
...
<?php $declaration=$bdd->prepare('SELECT * from declaration where id_navire=?');
               ...
               <br>
                            ...
                            <input type="text" class="" placeholder="numero manifeste" name="manifeste" style="width:45%; margin-right:20px ">
                                  ...
                                  <select id="prod1" name="des_douaniere" class=" " style="width:45%; margin-right:20px; margin-bottom:20px;" onchange="getpoids()">
   ...
   <center>
<button class="btn" style="width: 100%; " name="ajout_declare">ajouter</button>
   </center> 
...
<td style="color: white;"><?php echo $aff['n_bl'] ?></td>
<td style="color: white;"><?php echo $aff['destination_douaniere'] ?></td>
<td style="color: white;"><?php echo $aff['statut_douaniere'] ?></td>
<td style="color: white;"> <?php echo $aff['n_manifeste'] ?></td>
<td style="color: white;"><?php echo $aff['numero_declaration'] ?></td>
<td style="color: white;"><?php echo $aff['poids_declarer'] ?></td>
