	...
	<div id="auth">
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-12">
				<div id="auth-right">
					<div class="auth-logo">
						<a href="inscription.php"><img src="assets/images/mylogo.ico" alt="Logo"> SIMAR</a>  
					...
					<form action="" method="POST">
                      ...
                      <label for="exampleFormControlInput1" class="form-label">Inserer les produits de la cale 2</label>
                        ...
                        <div class=" mb-4" id="cale2" style="margin-top: 20px;">
                      ...
                      <label for="exampleFormControlInput1" class="form-label">Inserer les produits de la cale 3</label>
                        ...
                        <div class="form-group position-relative has-icon-left mb-4" id="cale3">
      ...
      <script type='text/javascript'>
            ...
            */
            function pcale1(){
                ...
                xhr.open("POST","cale_vrac.php",true);
