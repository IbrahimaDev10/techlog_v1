...
$supprimerDemande=$bdd->prepare('delete from dispatching where id_dis=?');
...
<span style="display: none;"  class="colcel" id="<?php echo $row2['id_dis'].'idclientdiscolvrac' ?>" ><?php echo $row2['idcli']; ?>  </span>
<span style="display: none;"  class="colcel" id="<?php echo $row2['id_dis'].'iddestidisvrac' ?>" ><?php echo $row2['id_mangasin']; ?>  </span>
 <span style="display: none;" class="colcel" id="<?php echo $row2['id_dis'].'id_navire_dis_delvrac' ?>" ><?php echo $row2['id_navire']; ?></span>
         ...
         <td id="<?php echo $row2['id_dis'].'poidsdisvrac' ?>" class="colcel"><?php echo number_format($row2['poids_t'], 3,',',' '); ?></td>
           ...
           <td class="colcel"  class="hide-on-print"><a  id="<?php echo $row2['id_dis'] ?>" name="deletedis" type="submit"  class="btn btn-text-danger" onclick="deleteDispatchingvrac(<?php echo $row2['id_dis'] ?>)" style="color:rgb(0,141,202); margin-left: 0px;"> <i class="fa fa-trash " ></i> </a>
