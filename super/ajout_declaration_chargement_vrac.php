...
<div class="form-group position-relative has-icon-left mb-5">
                     ...
                     <select id="produit" name="produit" class=" " style="width:45%; margin-right:20px; margin-bottom:10px;" onchange="getpoids()">
                       ...
                       <?php  
                            $p=$bdd->query("select * from categories");
                            while ($a1=$p->fetch()) { ?>
                                                            
                           <option value=<?php echo   $a1["id_categories"]; ?> > <?php    echo  $a1['nom_categories']; ?>  </option>
                             <?php   }  ?> 
                               </select>
                            ...
                            <input id="tonnage" type="text" class="" placeholder="tonnage" name="tonnage" style="width:45%; margin-right:20px; margin-bottom:10px;">
                       <input id="nom_chargeur" type="text" class="" placeholder="nom_chargeur" name="nom_chargeur" style="width:45%; margin-right:20px; margin-bottom:10px;"> 
                         <input id="id_navire" type="text" class="" placeholder="nom_chargeur"  style="width:45%; margin-right:20px; margin-bottom:10px; display: none;" value=<?php echo $idm; ?>>
                       </div>                                                  
   ...
   <center>
<a class="btn" style="width: 100%;" name="ajout_dc_vrac" data-role="ajout_dc_vrac">ajouter</a>
   </center>                                         
	...
	<div class="col col-lg-6">
		...
		<center>
		 ...
		 <div id="donnees_cale" class="table-responsive" border=1 >
          <center>
...
<script type="text/javascript">
 $(document).on('click','a[data-role=ajout_dc_vrac]',function(){
    ...
    if(tonnage!='' && cale!=''  && produit!='' && id_navire!=''){   

        
        $.ajax({
		url:'ajax_ajout_dc/ajout_cale_vrac.php',
		method:'post',
		data:{tonnage:tonnage,cale:cale,produit:produit,nom_chargeur:nom_chargeur,id_navire:id_navire},
