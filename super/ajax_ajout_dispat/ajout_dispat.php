...
if($_POST['type']=="VRAQUIER"){
    ...
    //  $poids_sac=$_POST['poids_sac'];
      ...
      $qualite=$_POST['qualite'];
             ...
             $insertDispat= $bdd->prepare("INSERT INTO dispats(quantite_sac,quantite_poids,poids_kgs,des_douane,type_decharge,id_con_dis,id_mangasin,id_qualite) VALUES(?,?,?,?,?,?,?,?)");
         ...
         $insertDispat->bindParam(4,$des_doua);
          ...
          $insertDispat->bindParam(8,$qualite);
