...
<li class="divider" data-text="Atrana">Clients</li>
 ...
 <li class="divider" data-text="Atrana">Statistique</li>
		...
		<div class="container-fluid dashboard">
			...
			<div class="container-fluid" >
				...
				<div class="col-lg-12">
                     ...
                     <a class="lienforme" href="" data-bs-toggle="modal" data-bs-target="#trans" style="">inserer</a>
                     </div>  
                     <br><br>
	...
	<div class="modal fade" id="trans" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary">
      	<center>
        <h1 class="modal-title fs-5 text-white text-center" id="exampleModalLabel " style="text-align:center; ">TRANSIT</h1></center>
...
<div class="form-group position-relative has-icon-left mb-4">
                          ...
                          <label for="exampleFormControlInput1" class="form-label">Inserer elements</label>
                           ...
                           <select id="p1" name="p1" class="mb-3 " onchange="pdispat()">
                            <option  selected>Ajouter des lignes supplementaires</option>
...
<script type='text/javascript'>
            ...
            */
            function pdispat(){
                ...
                xhr.open("POST","transit_form.php?m=<?php echo $_GET['m']; ?>" ,true);
