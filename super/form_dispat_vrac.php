...
function formulaire_insert_dc(){
  ...
  echo '<div class="form-group position-relative has-icon-left mb-5">';
                       ...
                       echo    '  
                            ...
                            <input type="text" class="" placeholder="tonnage" name="tonnage[]" style=" margin-right:20px";>
                        ...
                        echo    '<option value="">choisir destination </option>';
                           ...
                           echo '</select>';                                            echo      ' <select id="" name="destination_douaniere[]" class=" "  " style=" margin-right:20px";>
...
formulaire_insert_dc();
  ...
  formulaire_insert_dc();
  formulaire_insert_dc();
  echo   '<button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5" name="valider_dispat_">valider</button> ';
 }  
