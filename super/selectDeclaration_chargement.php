      ...
      <div class="col col-sm-12 col-md-12 col-lg-12"  >
        ...
        <button class="dropdown-toggle" style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; width: 20%; font-size:16px;  background: white; align-items: center;  "  class="btn " type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >PLAN DE CHARGEMENT </button>
         <ul id="drop_debarquement" class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="background: white;">
          <center>
          <li>
          <button  style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; background: white;  "  class="btn "id="btncale" onclick="visibleCale();">PAR CALE</button>
        </li>
         ...
         <ul id="drop_debarquement" class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="background: white;">
          <center>
            <li>
          <button  style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; background: white;  "  class="btn " onclick="visibleBl();">PAR CONNAISSEMENT</button>
        </li>
          <li>
          <button  style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; background: white;  "  class="btn " onclick="visibleClient();">PAR RECEPTIONNAIRE</button>
        </li>
               
          <li><button style=" display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px;  background: white;  "  class="btn "onclick="visibleDestination();" >PAR DESTINATION</button></li>
           ...
           <button style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; background: white;  "  class="btn " id="btnAvariesRep" onclick="visibleBl_unique();">CONNAISSEMENT</button>
             <button style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; background: white; "  class="btn " >TRANSIT</button>
...
<label>Choisir Connaissement</label><br>
  <select id="id_con_dis" style="width:50%;">
      <?php $connais_dis=$bdd->prepare("SELECT nc.id_connaissement, nc.num_connaissement,nc.poids_kg,p.produit,p.qualite FROM numero_connaissements as nc 
...
$connais_dis->execute(); 
       ...
       while($connais=$connais_dis->fetch()){
           ?>
           <option value="<?php echo $connais['id_connaissement'].'-'.$connais['poids_kg']; ?>"> <?php echo $connais['num_connaissement'] ?> (Produit <?php echo $connais['produit'] ?> <?php echo $connais['qualite'] ?>  <?php echo $connais['poids_kg'].' KG' ?>)</option>
         <?php } ?>
     </select>
  <br><br>
...
<div id="info_politique_modif_cale"> <span style="color:black;">NB:</span> <span style="color:red;"> Pour pus de securite certains champs ont ete desactives <a href="" style="text-decoration: underline;">en savoir plus</a></span></div> <br>
   <div class="mb-3">
    ...
    <div <?php if($ro['type']=="VRAQUIER"){ ?> style="display: none;" <?php } ?>>
  ...
  <input type="text"   class="form-control"  id="sac" name="nombre_sac" ><br>
   ...
   <div <?php if($ro['type']=="SACHERIE"){ ?> style="display: none;" <?php } ?>>
    <label>POIDSS</label>
