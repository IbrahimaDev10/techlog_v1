...
<?php $choix_client=$bdd->prepare('SELECT nc.num_connaissement,nc.id_navire,cli.client,cli.id   from client as cli
	...
	<select name="produit" id='produit' style="max-width: 30%;" data-role='detail_produit'>
		<option>CHOISIR produit</option>
		
		
	</select>

	<select name="connaissement" id='connaissement' style="max-width: 30%;" data-role='detail_connaissement' >
		<option>CHOISIR connaissement</option>
		
		
	</select> <br><br>

                                     <label>Date relache</label>
                            <input type="date"      id="date_relache" style=" width:50%;  margin-bottom: 10px;"><br><br>

                                     <label>Numero relache</label>
                            <input type="text"      id="numero_relache" style=" width:50%;  margin-bottom: 10px;"><br><br>                                                   

                            <label>Quantite relache</label>
                            <input type="text" class=""   placeholder="TONNAGE"  id="quantite_relache" style=" width:50%;  margin-bottom: 10px;"><br><br>
   ...
   <center>
<a class="btn" style="width: 100%;" name="ajout_relache" data-role='ajout_relache'>ajouter</a>
   </center>                                         
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
	...
	/*	var poids= $('#poids2').val(); 
		...
		var date_relache=$('#date_relache').val();
		var quantite_relache=$('#quantite_relache').val();
		var numero_relache=$('#numero_relache').val();
		var id_navire=$('#id_navire').val();
		$.ajax({
        url:'ajax_ajout_relache_bon/ajout_relache.php',
        method:'post',
        data:{connaissement:connaissement,date_relache:date_relache,quantite_relache:quantite_relache,id_navire:id_navire,numero_relache:numero_relache},
        success: function(response){
