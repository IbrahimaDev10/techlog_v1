...
$supprimerDemande=$bdd->prepare('delete from transit where id_trans=?');
...
<?php } ?>
  ...
  font-weight: bold;
   ...
   <button style="margin:auto-right;" class="btn btn-primary" onClick="imprimertransit('partransit')">imprimer</button>
</div>
