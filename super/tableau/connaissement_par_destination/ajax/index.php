...
require('../../../controller/connaissement_par_destination/tableau_connaissement_destinationController.php');
$b=$_POST["navire"];
...
$types=$nav->fetch();
 ...
 ?>
          ...
          <thead> 
          <tr id='entete_head' style="text-align: center;">  <td colspan="6">DISPATCHING PAR DESTINATION <br>
 ...
 <tr style="color:white; font-weight: bold; color:white; font-weight: bold; background: linear-gradient(to bottom, #FFFFFF, rgb(0,141,202));  border-color: white; text-align: center; font-size: 14px;" border='5' >
                          ...
                          <?php affichage_par_destination($bdd,$b); ?>
