...
try{
     $insertRecep1= $bdd->prepare("UPDATE dispats set /*id_con_dis=?, quantite_sac=?,  id_client=?, id_produit=?, poids_kg=? , id_mangasin=?, quantite_poids=?, des_douane=?*/ quantite_poids=?, poids_kgs=?, des_douane=?, type_decharge=?, id_mangasin=?, id_con_dis=?, id_produits=?  where id_dis=? "); 
