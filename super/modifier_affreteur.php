...
$res4n= $bdd->prepare("select * from affreteur where id=?  ");
...
try{
     ...
     $insertRecep1= $bdd->prepare("UPDATE affreteur set affreteur=?,  adresse_affreteur=? , tel_affreteur=?  where id=? "); 
...
<center>
  ...
  <input style="height: 25px;" type="text" class="form-control"  id="exampleFormControlInput1"  name="client" value="<?php echo htmlspecialchars($row['affreteur'])  ?>" ><br>
    ...
    <label>ADRESSE</label>
    <input style="height: 25px;" type="text" class="form-control"  id="exampleFormControlInput1" placeholder="chauffeur" name="adresse" value="<?php echo htmlspecialchars($row['adresse_affreteur'])  ?>" ><br>
     <label>TELEPHONE</label>
     <input style="height: 25px;" type="text" class="form-control"  id="exampleFormControlInput1"  name="tel" value="<?php echo htmlspecialchars($row['tel_affreteur'])  ?>" ><br>
     <label>EMAIL</label>
      <input style="height: 25px;" type="text" class="form-control"  id="exampleFormControlInput1"  name="email" value="<?php echo htmlspecialchars($row['email_affreteur'])  ?>" >
</div>
