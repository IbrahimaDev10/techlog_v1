...
$fichier=$bdd->prepare('select * from fichier_reception where id_fichier_recep=?');
...
<div class="container-fluid"  id="recap_bl"  style="width: 50%; background: white;" >
  <div class="row">
   ...
   <?php $id=$_GET['id'];
   $donnees=ticket_recep_sain($bdd,$id);
  ...
  <div style="float: right; margin-top: 15px;" class="col col-md-12  col-lg-12"> <h6 class="segment"> BL N°:  <?php echo $dnn['bl_recep']; ?> </h6></div><br>
...
<br><br>
        ...
        <div style="float: left; margin-top:15px;" class="col col-md-4 col-lg-4"> <h6 class="segment"> NOMBRE SAC : <span class="titre_info"> <?php echo $dnn['sac_recep']; ?> </span></h6></div>
         <div style="margin-top:15px;" class="col col-md-4 col-lg-4"> <h6 class="segment"> POIDS  <span class="titre_info"> <?php echo $dnn['poids_recep']; ?> </span></h6></div>
          <div style="margin-top:15px;" class="col col-md-4 col-lg-4"> <h6 class="segment"> SACS MANQUANTS  <span class="titre_info"> <?php echo $dnn['manquant_recep']; ?> </span></h6></div>
      

       
       <div style="float:left;" class="col col-md-6 col-lg-4"> <h6 class="segment"> CAMIONS: <span class="titre_info"> <?php echo $dnn['camion_recep']; ?> </span></h6></div>
       <div  class="col col-md-4 col-lg-4"> <h6 class="segment"> CHAUFFEUR: <span class="titre_info"> <?php echo $dnn['chauffeur_recep']; ?> </span></h6></div>
    ...
    <div style="float: left;" class="col col-md-4 col-lg-4">
       ...
       <div style="float: right;" class="col-md-4 col-lg-4">
        ...
        <?php while($fiche=$fichier->fetch()){
          ...
          ?>
          <div id="<?php echo $fiche['id_fich_recep'].'entrepot' ?>">
          <a target="blank_page" href="<?php echo $fiche['path_fichier_recep']; ?>" style="float: left;"><i class="fas fa-file-pdf " style="color: red; "></i><?php echo $fiche['nom_fichier_recep'] ?></a><a style="float:right;"  id="<?php echo $fiche['id_fichier_recep'] ?>" name="deleteMg"   class="fabtn1 " onclick="deleteFichier(<?php echo $fiche['id_fichier_recep'] ?>)" > <i class="fa fa-trash   " ></i> </a> <br><br>
          </div>
        <?php } ?>
