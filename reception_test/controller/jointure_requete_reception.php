<?php 
    function connaissement_declaration(){
      return ' inner join numero_connaissements as nc on nc.id_connaissement=dis.id_con_dis '; 
    }
   

    function declaration_dispat(){
    	return ' inner join declaration as d on d.id_bl=dis.id_dis ';
    }
