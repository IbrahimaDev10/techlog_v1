...
if(isset($_POST['connaissement'])){
	$c=$_POST['connaissement'];
...
<div class="modal fade" id="form_modifier_conteneur" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
		</div>		
	...
	<input style="width: 100%; border-top: none; border-left: none; border-right: none;" type="text" placeholder="rechercher ici le numero conteneur" name="" data-role="afficher_num_bl_modif" id="affiche_modif"><br>	
 <div id="mes_num_bl_modif" style="display: none; background: blue;">
 	
 </div><br>		
		<label>DATE</label><br>
  <input style="width: 100%;" type="date"  name=""  id="dates_m"><br>	<br>	
 	
 
 <input  style="width: 45%; " type="text"  id="val_num_modif" value="<?php echo $c; ?>">	
 <input style="width: 45%; margin-left: 5%; " type="text" id="poids_kg_m"  name=""> 
 <input style="width: 45%;" type="text" placeholder="sacs sains" id="sain_m">
 <input style="width: 45%; margin-left: 5%;" type="text" placeholder="sacs flasques" id="flasque_m"><br><br>		
 <input style="width: 45%;" type="text" placeholder="sacs mouilles" id="mouille_m">
 <input style="width: 45%; margin-left: 5%;" type="text" placeholder="CAMION" id="camion_m">
 <br><br>	
 <select id=transporteur_m>
 	<option>choisir un transporteur</option>
 	<?php $transporteur=gettransporteur($bdd);
 	while($trans=$transporteur->fetch()){
    ?>
...
<?php } ?>
 ...
 <input style="width: 45%; margin-left: 5%; " type="text" id="val_id_num_conteneur_m" name="">
 <?php $declaration=getdeclaration($bdd,$c);
     if($dec=$declaration->fetch()){
  ?>

 <input style="width: 45%; margin-left: 5%; display: none;" type="text" id="id_declaration_m" value="<?php echo $dec['id_declare'];  ?>" name=""> <?php } ?><br><br>
  
  <center>
 <a class="btn-primary" data-role="modifier_reception">VALIDER</a>
 </center>
