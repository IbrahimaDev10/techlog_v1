    ...
    if (in_array($fileActualExt, $allowed)) {
        if ($fileError === 0) {
            if ($fileSize < 1000000000) { // taille maximale de 1 Mo
                ...
                $req =$bdd->prepare("INSERT INTO fichier_liv_sain (nom_fichier_liv_sain , path_fichier_liv_sain , taille_fichier_liv_sain , type_fichier_liv_sain , id_fichier_liv_sain ) VALUES (?,?,?,?,?)");
...
$fichier=$bdd->prepare('select * from fichier_liv_sain  where id_fichier_liv_sain =?');
...
<div class="container-fluid"  id="recap_bl"  style="width: 50%; background: white;" >
  <div class="row">
     ...
     <div id="no-print" style="background: blue;">
...
<form method="POST" enctype="multipart/form-data">
  <div style="display: flex; justify-content: center;">
      ...
      <div class="col col-md-6 col-lg-6" style="display: flex; justify-content: center;">
        ...
        <button  type="submit" class="" style="text-align: center; background: none; border: none;" name="fichier_entrepot" id="deb"  ><i class="fa fa-paperclip fa-2x"></i></button>
        </div>
         
       <div style="float: right; " class="col-md-6 col-lg-6">
         <a   class="btn btn-primary " style="text-align: center; background: none;"  data-role="imprimer_bl_deb"  ><i class="fa fa-print fa-2x"></i></a>
         </div>
         </div>
        <br><br>
</form> 
   ...
   <?php $id=$_GET['id'];
   $donnees=ticket_livraison_sain($bdd,$id);
  ...
  <div style="float: right; margin-top: 15px;" class="col col-md-12  col-lg-12"> <h6 class="segment"> BL N°:  <?php echo $dnn['id_liv']; ?> </h6></div><br>
...
<br><br>
        ...
        <div style="float: left; margin-top:15px;" class="col col-md-6 col-lg-6"> <h6 class="segment"> NOMBRE SAC : <span class="titre_info"> <?php echo $dnn['sac_liv']; ?> </span></h6></div>
         <div style="margin-top:15px;" class="col col-md-6 col-lg-6"> <h6 class="segment"> POIDS  <span class="titre_info"> <?php echo $dnn['poids_liv']; ?> </span></h6></div>
 
      

       
       <div style="float:left;" class="col col-md-6 col-lg-4"> <h6 class="segment"> CAMIONS: <span class="titre_info"> <?php echo $dnn['camion_liv']; ?> </span></h6></div>
       <div  class="col col-md-4 col-lg-4"> <h6 class="segment"> CHAUFFEUR: <span class="titre_info"> <?php echo $dnn['chauffeur_liv']; ?> </span></h6></div>
       <div  class="col col-md-4 col-lg-4"> <h6 class="segment"> PERMIS: <span class="titre_info"> <?php echo $dnn['num_permis_liv']; ?> </span></h6></div>
        <div  class="col col-md-4 col-lg-4"> <h6 class="segment"> TELEPHONE: <span class="titre_info"> <?php echo $dnn['tel_liv']; ?> </span></h6></div>
      <div class="col col-md-12 col-lg-12" style="border: solid; border-top:2px; border-left:none; border-right: none; border-color:rgba(50, 159, 218, 0.9);"   > </div>
      <br><br>
...
<?php } ?>
        ...
        <?php while($fiche=$fichier->fetch()){
          ...
          ?>
          <div id="<?php echo $fiche['id_fich_liv_sain'].'entrepot' ?>">
          <a target="blank_page" href="<?php echo $fiche['path_fichier_liv_sain']; ?>" style="float: left;"><i class="fas fa-file-pdf " style="color: red; "></i><?php echo $fiche['nom_fichier_liv_sain'] ?></a><a style="float:right;"  id="<?php echo $fiche['id_fichier_liv_sain'] ?>" name="deleteMg"   class="fabtn1 " onclick="deleteFichier(<?php echo $fiche['id_fichier_liv_sain'] ?>)" > <i class="fa fa-trash   " ></i> </a> <br><br>
          </div>
        <?php } ?>
