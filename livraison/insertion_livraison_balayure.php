 ...
 // $bl_simar=$_POST['bl_simar'];
  ...
  $poids=$sac*$poids_sac/1000;
   ...
   $poids_bl_livraison_balayure=poids_bl_livraison_balayure($bdd,$bl_fournisseur);
	...
	$insert=$bdd->prepare("INSERT INTO livraison_balayure(date_bal,heure_bal,bl_fournisseur_bal,camion_bal,chauffeur_bal,tel_bal,num_permis_bal,dec_bal,relache_bal,sac_bal,poids_bal,poids_sac_bal,id_produit_bal,id_dis_bal,id_navire_bal,bl_simar_bal) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
