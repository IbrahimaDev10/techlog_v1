...
require('../database.php');
   ...
   echo " <select id='client_tr' name='client' onchange='goClient_tr()'>
...
$res2 = $bdd->prepare("SELECT dis.id_dis ,  nc.id_produit , nc.id_client, nc.id_navire, cli.client, mg.id_mangasinier,mg.mangasin from dispats as dis 
                 ...
                 where nc.id_navire=? AND mg.id_mangasinier=?  group by nc.id_client ");
   ...
   /*             $res2 = $bdd->prepare("SELECT dis.id_dis ,  dis.id_produit , dis.id_client, nc.id_navire, cli.client, mg.id_mangasinier,mg.mangasin,tr.id_nouvelle_destination,dt.id_mangasinier_transfert from dispat as dis 
                 ...
                 where nc.id_navire=? and (mg.id_mangasinier=? or dt.id_mangasinier_transfert=?) group by dis.id_client ");
