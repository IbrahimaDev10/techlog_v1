...
$supprimerDemande=$bdd->prepare('delete from register_manifeste where id_register_manif=?');
...
<?php  
if($diff<0){ ?>
  <td  style="color: red;"><?php echo "EXCEDENT SUR DECLARATION / DESTINATION" ?></td>
