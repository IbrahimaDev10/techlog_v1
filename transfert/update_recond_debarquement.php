...
if(isset($_POST['navire']) ){
 ...
 try{       
          $insertRecep1= $bdd->prepare("UPDATE recond_debarquement SET  date_recond_tr=? , sac_dechires=? , poids_dechires=? , sac_obtenus=? , poids_obtenus=? WHERE id_recond_tr=? ");      
