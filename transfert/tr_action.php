...
$transport=$bdd->query("select * from transporteur order by id desc");
 ...
 $rescaleAvaries= $bdd->prepare("SELECT  *  FROM dispatching 
  ...
  <div id=masquage style="">   
        <div  class="entete_image" style="background-image: url('../images/bg_page.jpg'); background-repeat: no-repeat; background-size: 100%; background-color: blue; margin-top: 2px; ">
        <center> 
 ...
 <table  class='table table-hover table-bordered table-striped'  border='2' style="width: 50%; " id='tabledec1'>
            ...
            <tr style="text-align: center; background: linear-gradient(to bottom, blue, #1B2B65); background: linear-gradient(to left, blue, #1B2B65); background: linear-gradient(to top, blue, #1B2B65); font-weight: bold;" >
...
$rob_poids=$row['poids_declarer']-$row['sum(rm.poids)']-$row2['sum(tr.poids_flasque_tr_av)']-$row2['sum(tr.poids_mouille_tr_av)'];
   ?>
   <tr style="text-align: center; background: white; font-weight: bold;">
 ...
 <table  class='table table-hover table-bordered table-striped'  border='2' style="width: 50%; " id='tabledec2' >
            ...
            <tr style="text-align: center; background: black; font-weight: bold; background: linear-gradient(to bottom, blue, #1B2B65); background: linear-gradient(to left, blue, #1B2B65); background: linear-gradient(to top, blue, #1B2B65);"> 
...
$rob_poids=$row['poids_t']-$row['sum(rm.poids)'];
   ...
   <tr style="text-align: center; background: white; font-weight: bold;"> <?php  if($row['type']=='SACHERIE'){ ?>
    <td>  
 <span class="th4" >
  ...
  <?php while($aff=$affiche->fetch()){ 
   ...
   $float = $bdd->prepare("SELECT count(bl) from register_manifeste
    ...
    ?>
      ...
      <td class="mytd" colspan="9" class="colaffnull" style="background: linear-gradient(to bottom, #FFFFFF, rgb(82,82,226)); font-weight: bold; color:white; font-size: 12px;" >TOTAL  <?php echo $date[2].'-'.$date[1].'-'.$date[0] ?></td>
...
<?php } ?>
   ...
   <?php 
    ...
    <td id="<?php echo $aff['id_register_manif'].'bl_rm' ?>"  ><?php echo $aff['bl'] ?></td>
...
<form >  
 <td  style="vertical-align: middle; " > <a   id="<?php echo $aff['id_register_manif'] ?>"    class="fabtn1" onclick="deleteAjax2m(<?php echo $aff['id_register_manif'] ?>)" > <i class="fa fa-trash  " ></i> </a>
...
<?php } ?>
   ...
   <?php }
    ...
    <td id="<?php echo $aff['id_tr_avaries'].'sacf_av' ?>" ><?php echo number_format($aff['sac_flasque_tr_av'], 0,',',' '); ?></td>
  ...
  <td  id="<?php echo $aff['id_tr_avaries'].'sacm_av' ?>" ><?php echo number_format($aff['sac_mouille_tr_av'], 0,',',' '); ?></td>
    <td  id="<?php echo $aff['id_tr_avaries'].'poidsm_av' ?>" ><?php echo $aff['poids_mouille_tr_av'] ?></td>
    <td ><?php echo number_format($TotalSacAV, 0,',',' ') ?></td>
    <td  ><?php echo number_format($TotalPoidsAV, 3,',',' ') ?></td>
 ...
 <a class="fabtn"  data-role='update_register_avaries'   data-id="<?php echo $aff['id_tr_avaries'];  ?>"    ><i class="fa fa-edit " ></i></a> </td>
     ...
     <?php if($aff['autre_destination_tr']!="AUCUNE"){ ?>
      <td class="colaffiche"><?php echo $aff['autre_destination_tr'] ?></td>
    <td class="colaffiche"><?php echo $aff['destinataire_tr'] ?></td>
  </tr>
<?php } ?>
...
<?php } ?>
   ...
   <div class="mb-3">
         ...
         <center>
        <button type="submit" class="btn btn-primary " style="text-align: center;" name="register" id="register" >enregistrer</button></center>
</form> 
      </div>   
...
<input type="search" id="myInput3"  placeholder="SAISIR LE N° DE CAMION" style="width: 50%; " onkeyup="filtreca3();" autocomplete="off">
<i class="fas fa-search" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%);"></i>
<input type="text" id="myInputTransp3" placeholder="transporteur" style="width: 50%; float: right;" disabled="true" >
...
<input type="text" id="myInputc3"  placeholder="chauffeur3" style="width: 100%;" onkeyup="filtreChau3();" autocomplete="off" >
...
<?php  
  ...
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="nbre sacs flasques" name="sac_flasque" >
</div>
  <div class="mb-3">
      
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="poids flasques" name="poids_flasque" >
</div>
  <div class="mb-3">
      
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="nbre sacs mouille" name="sac_mouille" >
</div>

  <div class="mb-3">
      
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="poids mouille" name="poids_mouille" >
</div>
...
<div class="modal fade" id="Les_avaries" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="navire"  name="navire"  id="navire" hidden="true" value=<?php  
        echo $rown['id_navire'];
    ?> > 
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="navire"  name="id_di"  id="navire" hidden="true" value=<?php  
        echo $rown['id_dis'];
    ?> >
...
<div class="modal fade" id="Les_avaries2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <br>  
    ...
    <input type="text" class="form-control" id="exampleFormControlInput1"   name="sacf"  id="navire"  value="0"
     >
     <br> 
     <label>SAC MOUILLE</label>
    <input type="text" class="form-control" id="exampleFormControlInput1"   name="sacm"  id="navire"  value="0"
     >
     <br> 
<select name="cale"> 
<option selected value=""> CHOISIR CALE</option> 
<?php  
while($res=$rescaleAvaries->fetch()){ 
            $rescaleAvaries2= $bdd->prepare("SELECT cales   FROM declaration_chargement
               

                   WHERE id_navire=? and id_produit=? and conditionnement=? 
                  ");
        $rescaleAvaries2->bindParam(1,$res['id_navire']);
        $rescaleAvaries2->bindParam(2,$res['id_produit']);
        $rescaleAvaries2->bindParam(3,$res['poids_kg']);
        $rescaleAvaries2->execute(); } 
    while($rownn=$rescaleAvaries2->fetch()){ ?>
      <option value=<?php echo $rownn['cales']; ?>><?php echo $rownn['cales']; ?> </option>
    <?php }  ?>
    </select>
  ...
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="navire"  name="navire"  id="navire" hidden="true" value=<?php  
    ...
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="navire"  name="id_di" hidden="true" value=<?php  
        echo $rown['id_dis'];
    ?> > 
     <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="navire"  name="poids_sac"  id="navire" hidden="true" value=<?php  
        echo $rown['poids_kg'];
    ?> >
     <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="navire"  name="id_produit"  id="navire" hidden="true" value=<?php  
        echo $rown['id_produit'];
    ?> >
   ...
   <div class="mb-3">
         ...
         <center>
        <button type="submit" class="btn btn-primary " style="text-align: center;" name="valider_Avaries3" id="C24H" onclick="go4()">enregistrer</button></center>
        </div>
      <?php }  ?>
...
<?php if($_SESSION['visible']==1){ ?>
  <script type="text/javascript">
    reg2=document.getElementById("TableSain");

    reg2.style.display="table";


  </script>
<?php } ?>

<?php if($_SESSION['visible']==2){ ?>
  <script type="text/javascript">
    reg2=document.getElementById("TableAvariesTrans");
  reg2.style.display="table";

  </script>
<?php } ?>

<?php if($_SESSION['visible']==3){ ?>
  <script type="text/javascript">
    reg2=document.getElementById("avaries_debarquement");
  reg2.style.display="table";
