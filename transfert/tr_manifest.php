...
header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); 
 if($_SESSION['profil']!="superviseur" and $_SESSION['profil']!="Admin" and $_SESSION['profil']!="Pointeur" and $_SESSION['profil']!="Mangasinier" and empty($_SESSION['aut']) ){
...
<div class="container LesOperations" style="padding-bottom: 0px !important; width: 100% !important;"    >
        <div class="row">
         
          
            <div class="col col-md-6 col-lg-3" >
                <center>  
                    <a style="font-size:14px !important;" id="btn_pre_debarquement"  class="btn " onclick="visible_EnregistrementBL()" ><i class="fas fa-sign-out-alt">  </i>
          ...
          <li><button style=" display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px;  background: white;  "  class="btn"  onclick="visible_Reconditionnement()"    >RECONDITIONNEMENT</button></li>
                     ...
                     <div class="col col-md-6 col-lg-3">
                <center>  
                    <a style="font-size:14px !important;" id="btn_debarquement" onclick="visible_Situations()" class="btn "  > <i class="fas fa-cog"> </i>
                        MES SITUATIONS
                    </a>
...
<input type=""  id="poids_sac_m_av"  ><br><br>
...
<div class="mb-3">
 ...
 <label style="">BL</label><br>  
  ...
  <input type="text" class="form-control"  id="poidsm_m_av"  name="conditionnement"  > <br>
...
<center>
  <div style="width: 50%;"> 
  <div class="container-fluid" style=" margin-left: 0; background: rgb(0,141,202); display: none;  margin-top: 5px !important;" id="select_enregistrement" >
		<div class="row">
				...
				<div class="col-lg-12 col-md-12">
					...
					<form method="POST" >
                        ...
                        <select id="produit" class="mysel" name="produit" style="margin-right: 2%; height: 30px;  width: 40%;" data-role='goProduit' >
...
<script type="text/javascript"> 
   ...
   /* var camionText = element.innerText;
    ...
    input3.value = transpText;
        ...
        camionList.style.display="block";
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'action_remorque.php', true);
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            camionList.innerHTML = xhr.responseText;
 ...
 */
  ...
  //$('#type').css('display', 'block');
    ...
    if(valsatut!='' &&  type=='SACHERIE'){
       var statut=$('#input_statut_new').val();
    }
        if(valsatut!='' && type=='VRAQUIER'){
       var statut='sain';
      //var avaries_de_deb=0;
       var transfert_sain=1;
            ...
            */
            function goDateSit(){
                ...
                xhr.onreadystatechange = function(){
                 ...
                 var client=$('#deb_client').text();
                        if(client==1){
                          $('#deb_by_client').css('display','table');
                        }
                        else{
                          $('#deb_by_client').css('display','none');
                        }
                        $('#statut_client').css('display','block');
                ...
                client=$('#statut_client').text();
                iddate = sel.options[sel.selectedIndex].value;
                xhr.send("idDate="+iddate,"client="+client);
            }
        </script>  
         <script type='text/javascript'>
    ...
    var transfert_sain_avaries = $('#transfert_sain_avaries').val();
     ...
     var transfert_avaries = $('#transfert_avaries').val();
      ...
      //var type_dec = $('#type_dec').val();
        ...
        $.ajax({
        url:'selectTableSituation.php',
        method:'post',
        data:{idDate:idDate,deb_client:deb_client,deb_cale:deb_cale,deb_produit:deb_produit,deb_destination:deb_destination,deb_av_cale:deb_av_cale,deb_av_produit:deb_av_produit,deb_av_destination:deb_av_destination,deb_sain:deb_sain,transfert_sain_avaries:transfert_sain_avaries,transfert_sain:transfert_sain,transfert_avaries:transfert_avaries,transfert_sain_deb:transfert_sain_deb},
        success: function(response){
            $('#sit').html(response);
...
// $('#blsain').val(bl);
 //$('#num_du_bl').text('cjdnjndsj');
   $.ajax({
    ...
    $.ajax({
        url:'update_select_declaration.php',
        method:'post',
        data:{navire:navire,produit:produit,poids_sac:poids_sac,destination:destination,statut:statut,client:client},
        success: function(response){
