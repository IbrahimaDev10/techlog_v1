...
try{
 ...
 // $_POST['poids'];
     ...
     $insertRecep1= $bdd->prepare("INSERT INTO transfert_debarquement(dates,heure,cale,bl,id_dis_bl,camions,chauffeur,id_declaration,sac,poids,id_produit,poids_sac,id_client,id_destination,id_navire,destinataire,statut,etat_reception,remorque_id) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
