...
$dec= $_POST['dec'];
 ...
 $chauffeur= $_POST['chauffeur'];
  ...
  $poids= $sac*$poids_sac/1000;
     ...
     $insertRecep1= $bdd->prepare("INSERT INTO transfert_flasque(dates,heure,id_camion,id_chauffeur,id_declaration,sac_flasque,poids_flasque,id_destination,id_produit,poids_sac,id_navire) VALUES(?,?,?,?,?,?,?,?,?,?,?)"); 
