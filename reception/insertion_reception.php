...
try{
$insert=$bdd->prepare("INSERT INTO reception(dates_recep,heure_recep,bl_recep,id_dis_recep_bl,id_dec,camion_recep,chauffeur_recep,sac_recep,poids_recep,manquant_recep,id_produit_recep,poids_sac_recep,id_client_recep,id_destination_recep,id_navire_recep) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
  $insert->bindParam(1,$date);
  $insert->bindParam(2,$heure);
  $insert->bindParam(3,$bl);
  $insert->bindParam(4,$id_dis_bl);
  $insert->bindParam(5,$declaration);
  $insert->bindParam(6,$camions);
  $insert->bindParam(7,$chauffeur);
  $insert->bindParam(8,$sac);
  $insert->bindParam(9,$poids);
  $insert->bindParam(10,$manquant);
  $insert->bindParam(11,$id_produit);
  $insert->bindParam(12,$poids_sac);
  $insert->bindParam(13,$client);
