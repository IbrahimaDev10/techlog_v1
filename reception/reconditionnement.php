...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $(document).on('click','a[data-role=insert_reconditionnement]',function(){
        var id_dis = $(this).data('id');
        var navire = $(this).data('navire_recond');
        var id_produit = $(this).data('id_produit_recond');
        var poids_sac = $(this).data('poids_sac_recond');
        var id_destination = $(this).data('id_destination_recond');
        var id_declaration = $(this).data('id_declaration_recond');
