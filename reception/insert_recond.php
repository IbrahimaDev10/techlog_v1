...
if(isset($_POST['navire'])){
 ...
 try{
	$insert=$bdd->prepare("INSERT INTO reconditionnement_reception(dates_recond,sac_eventres,poids_eventres,sac_av_recond,poids_av_recond,sac_balayure_recond,poids_balayure_recond,poids_sac_recond,id_produit_recond,id_destination_recond,id_navire_recond,id_dis_recond,id_declaration_recond) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
$insert->bindParam(13,$id_declaration);
$insert->execute();
}
