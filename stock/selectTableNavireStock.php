...
if(isset($_POST["idNavire"])){
    ...
    $navires=$bdd->prepare("select * from navire_deb where id=?");
    $navires->bindParam(1,$idNavire);
    $navires->execute();
            ...
            <tbody> 
                ...
                <?php
                 ...
                 empty($idProduit) and empty($idDis)){
                    ...
                    ?>
                    <tr class="tr_data_gestion_stock" >
                        <td colspan="3">TOTAL <?php echo " ".$row['mangasin'] ;?></td>
                ...
                <tr class="trGestionStockTotal">
                    <td colspan="3">TOTAL <?php while ($row=$navires->fetch()) {$navireSelect = $row['navire'];}echo " ".$navireSelect; ?> </td>
