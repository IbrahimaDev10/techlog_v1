...
if(isset($_POST["idBanque"])){
    $idBanque=$_POST["idBanque"];
    $banques=$bdd->prepare("select * from banque where id=?");
    $banques->bindParam(1,$idBanque);
    $banques->execute();
            ...
            <tbody> 
               ...
               <?php
                ...
                <tr class="trGestionStockTotal">
                    <td colspan="3">TOTAL <?php while ($row=$banques->fetch()) {$banqueSelect = $row['banque'];}echo $banqueSelect; ?> </td>
