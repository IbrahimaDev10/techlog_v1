...
<div class="container LesOperations"   <?php if($_SESSION['profil']=='pont'){  ?> style='display: none;' <?php } else{ ?> style="padding-bottom: 0px !important; width: 100% !important;" <?php } ?> >
        <div class="row">
         
          
            <div class="col col-md-4 col-lg-4" >
                <center>  
                    <a style="font-size:14px !important; color: black !important;" id="btn_pre_debarquement"  class="btn " onclick="visible_EnregistrementBL()" ><i class="fas fa-list"></i>
          ...
          <!--       <div class="col col-md-6 col-lg-3">
                <center>  
                    <a style="font-size:14px !important;" id="btn_debarquement"  class="dropdown-toggle btn" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > <i class="fas fa-seedling"> </i>
                        AVARIES DE DEBARQUEMENT
                    </a>
                    <ul id="drop_debarquement" class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="background: white;">
          <center>
          <li>
          <li><button style=" display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px;  background: white;  "  class="btn " id="btnMouille" onclick="visible_Avaries()"  >AJOUTER AVARIES</button></li>
        </li>
                
          <li><button style=" display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px;  background: white;  "  class="btn"  onclick="visible_Reconditionnement()"    >RECONDITIONNEMENT</button></li>
      </center>
  </ul>
                     ...
                     <div class="col col-md-4 col-lg-4" >
                <center>  
                    <a style="font-size:14px !important;" id="btn_debarquement" onclick="visible_Situations()" class="btn "  > <i class="fas fa-chart-line"></i> </i>
                        MES SITUATIONS
                    </a>
              ...
              <div class="col col-md-12 col-lg-12" <?php if($_SESSION['profil']=='superviseur'){  ?> style='display: none;' <?php } ?>>
                <center>  
                    <a style="font-size:14px !important; color: black" id="btn_pont" onclick="visible_Pont()" class="btn "  > <i class="fas fa-balance-scale"> </i>
                        PONT BASCULE
                    </a>
...
#btnAvariesDeb{
 ...
 .colLibeles{
      background: rgba(138,220,255,0.9) !important;
       color: white;
      vertical-align: middle;
      text-align: center;
      white-space: nowrap;
     ...
     .colManifeste{
      background: rgba(0,148,210,0.9) !important;
       color: white;
      vertical-align: middle;
      text-align: center;
      white-space: nowrap;
    ...
    .colDeb24H{
      background: rgba(4,180,255,0.9) !important;
       color: white;
      vertical-align: middle;
      text-align: center;
      white-space: nowrap;
     ...
     .colDebTOTAL{
      background: rgba(70,200,255,0.9) !important;
       color: white;
      vertical-align: middle;
      text-align: center;
      white-space: nowrap;
      ...
      white-space: nowrap;
            ...
            .TOTAL{
      background: rgba(0,22,32,0.9) !important;
       color: white !important;
      vertical-align: middle;
      text-align: center;
      white-space: nowrap;
...
#tableau_sain {
  position: relative;
  height: 800px; /* Ajustez la hauteur en fonction de votre besoin */
  overflow-y: auto;
}
...
<div class="sidebar transition overlay-scrollbars animate__animated  animate__slideInLeft" style="background: linear-gradient(-45deg, #004362, #0183d0) !important; ">
 ...
 <div class="bars">
	...
	<!--Content Start-->
	<div class="content-start transition" style="padding-top: 0px !important; top: 0px !important; " >
...
<center>
  <div style="width: 50%;"> 
  <div class="container-fluid" style=" margin-left: 0; background: rgb(0,141,202); display: none;  margin-top: 1px !important;" id="select_enregistrement" >
		<div class="row">

			

				<div class="col-lg-12 col-md-12">
					<h1 class="hem" style="font-size: 16px !important;"> ENREGISTREMENT DES BONS DE TRANSFERT / LIVRAISON </h1><br>
					...
					<form method="POST" >
                       ...
                       <center>
                           ...
                           <?php  $produit_nav=produit_du_navire($bdd,$navire_initiale); ?>
                        <select id="produit" class="mysel" name="produit" style=" height: 30px;  width: 40%;" data-role='goProduit' >
    ...
    <!--  div pour cacher print !-->
       ...
       <div class="container-fluid2 " id="main" style="width: 100%; margin:0; ">
      <div class="row">
    ...
    <div class="container-fluid2" id="pont_deb" <?php if($_SESSION['profil']=='pont'){  ?> style='display: block;' <?php } else{ ?> style='display: none;' <?php } ?> >
      <div class="row" >
      ...
      <a id="liste"  style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px; margin-right: 30px;" data-role="liste_camion"><i style="color: blue;" class="fas fa-truck" ></i> Liste des camions en attentes</a>
       ...
       <a id="vue_reception" style="display: flex; justify-content: center; color: blue; border:solid; border-color: blue; border-radius: 50px;"  onclick="camions_peses()"><i style="color: blue;" class="fas fa-eye" ></i> </i>Camions pesés</a>
       </span>
    </div>
<br><br>
...
<input type="text" name="" id='client_pont'>
   ...
   <div class="mb-3">
    ...
    <center>
  <div style="width: 50%; display: none;" id='espace_produit_pont'> 
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <form method="POST" >
                       ...
                       <center>
                           ...
                           <?php  $produit_nav=produit_du_navire($bdd,$navire_initiale); ?>
                        <select id="produit_pont_bascule" class="mysel" name="produit" style=" height: 30px;  width: 40%;" data-role='goProduit_pont' >
                            <option value=""   >selectionner produit</option>
                            <?php  while($prod=$produit_nav->fetch()){ ?>
                               <option   value=<?php echo $prod['id_produits'].'-'.$prod['poids_kgs'].'-'.$prod['nav_id'].'-'.$prod['id_mangasin'].'-'.$prod['id_dis'].'-'.$prod['type'].'-'.$prod['id_client']; ?> > <span class="produit"> <?php echo $prod['produit']; ?></span>  <span class="poids"><?php echo $prod['poids_kgs']; ?> KGS</span> <?php echo $prod['client']; ?> /<?php echo $prod['mangasin']; ?> </option>
                             <?php  } ?>
