...
<div class="table-responsive" style="background: white;" >
	<h6>NAVIRE <?php echo $_POST['navire']; ?> <?php echo $soustraction; ?></h6>
 <h6>SITUATION DU DEBARQUEMENT PAR CALE DU <?php echo $_POST['idDate']; ?> </h6>        
    ...
    if(!empty($deb_ROB['sum(td.sac)'])){
     ...
     $net_marchand_ROB=$manif['sum(poids)']-$deb_ROB['sum(pb.poids_net)'];
         ...
         <tr class="cellule">
         	...
         	<td rowspan="<?php echo /*$row_cale-$soustraction;*/$rows_deb['nombre_de_lignes']; ?>"><?php echo $row['cales']; ?> <?php echo $row_cale ?> </td>
         <?php } ?>
