        ...
        ?>
               <select style="max-width: 200px;" id="connaissement" data-role="choix_connaissement">
                ...
                <select id="statut" >
               	...
               	<option value="1">DEPASSEMENT</option>
                       ...
                       <input id="numero" type="text" class="" placeholder="numero relache" name="manifeste" style="width:45%; margin-right:20px ">            
  ...
  //$('#type').css('display', 'block');
    ...
    var id_navire = $('#navire').val();
      //var type_dec = $('#type_dec').val();
        ...
        $.ajax({
        url:'afficher_select_banque.php',
        method:'post',
  ...
  //$('#type').css('display', 'block');
    ...
    var id_connaissement = $('#connaissement').val();
      //var type_dec = $('#type_dec').val();
        ...
        $.ajax({
        url:'afficher_select_produit.php',
        method:'post',
    ...
    var quantite = $('#quantite').val();
     var numero = $('#numero').val();
      ...
      //var type_dec = $('#type_dec').val();
        ...
        method:'post',
        data:{connaissement:connaissement,navire:navire,produit:produit,quantite:quantite,numero:numero,date:date,statut:statut},
        success: function(response){
