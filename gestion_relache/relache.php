...
<html lang="fr">
  <head>
	...
	<title>GESTION DES RELACHES</title>
  ...
  <?php include('topbar.php'); ?>
    ...
    <div class="row">
        ...
        <div class="col col-md-12 col col-lg-12">
          <center>
        <a style="color: white;" id="bouton_ajout_declaration" href="ajouter_relache.php"><i class="fas fa-add"></i> Ajouter nouvel relâche</a>
        <a  style="color: white;" href="dispatcher_relache.php"><i class="fas fa-eye"></i> Dispatcher relache</a>
        <a  style="color: white;" href="dispatcher_bon.php"><i class="fas fa-eye"></i> Dispatcher bon</a>
         <a id="bouton_mes_declarations" style="color: white;" data-role="afficher_select"><i class="fas fa-eye"></i> Mes relaches</a>
    <!--    <a id="ons" style="color: blue;"  href="rembourser_relache.php"><i class="fas fa-eye"></i> Remboursement relaches</a>
         <a id="" style="color: blue;" href="dispatcher_remboursement_relache.php" ><i class="fas fa-eye"></i> Dispatcher Remboursement relaches</a> !-->
          <a style="color: white;" id="bouton_ajout_declaration" href="ajouter_bon"><i class="fas fa-add"></i> Ajouter un bon d'enlevement</a>
           <a style="color: white;" id="bouton_ajout_declaration" href="parametres_relache_bon"><i class="fas fa-cog"></i> Parametres</a>
        </center>
    </div>
...
<br><br>
 ...
 <div class="container-fluid" style="background-image: linear-gradient(-45deg, #004362, #0183d0); !important; width: 50%; display: none;" id='partie_select_form'>
    <div class="row">
   ...
   <div class="container-fluid" style="background-image: linear-gradient(-45deg, #004362, #0183d0); !important; width: 50%; display: none;" id='partie_select'>
    <div class="row">
        ...
        <div class="col col-md-12 col col-lg-12">
         ...
         <center>
        <select id="navire" data-role="afficher_relache">
...
<script type="text/javascript">
  $(document).ready(function(){
    $(document).on('change','select[data-role=afficher_relache]',function(){
  //$('#type').css('display', 'block');
