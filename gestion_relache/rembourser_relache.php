...
<?php 
        ?>
               <select id="relache" data-role="choix_relache">
  ...
  //$('#type').css('display', 'block');
    ...
    var id_navire = $('#navire').val();
      //var type_dec = $('#type_dec').val();
        ...
        $.ajax({
        url:'afficher_select_relache.php',
        method:'post',
        data:{id_navire:id_navire},
        success: function(response){
            $('#relache').html(response);
  ...
  //$('#type').css('display', 'block');
    ...
    var quantite = $('#quantite').val();
      ...
      //var type_dec = $('#type_dec').val();
        ...
        $.ajax({
        url:'insertion_remboursement_relache.php',
        method:'post',
        data:{relache:relache,navire:navire,quantite:quantite,date:date},
        success: function(response){
