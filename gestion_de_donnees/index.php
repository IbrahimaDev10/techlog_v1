...
<html lang="fr">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../super/gestion_donnees.css">
...
.dataTables_wrapper .dataTables_paginate .paginate_button.current {
  ...
  <div class="topbar transition">
	...
	<div class="row">
		<div>
			<h2 style="background: yellow; border-top-right-radius: 60%;">GESTION DE DONNEES</h2>
		</div>
 ...
 <?php //include('../super/ajout_nouvelle_donnees.php'); ?>
     ...
     <li>
                    ...
                    <ul class="side-dropdown">
                       ...
                       <li><a style="font-size: 15px;" class="btn text-white "    id="btnNavire" data-role='voir_navire'> NAVIRES</a></li>
						<li><a style="font-size: 15px;"  class="btn text-white "  data-role='voir_categories'>CATEGORIES</a></li>
						<li><a style="font-size: 15px;"  class="btn text-white "  data-role='voir_produit'> PRODUITS</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  data-role='voir_client'> RECEPTIONNAIRES</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  data-role='voir_entrepot'> ENTREPOTS</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  onclick="visible_affreteur()"> FOURNISSEURS</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  onclick="visible_banque()"> BANQUES</a></li>
					
						<li><a style="font-size: 15px;" class="btn text-white "  data-role='voir_transporteur'> TRANSPORTEURS</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  data-role='voir_chauffeur'> CHAUFFEURS</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  data-role='voir_camion'> CAMIONS</a></li>
						<li><a style="font-size: 15px;" class="btn text-white "  onclick="visible_mangasinier()"> MANGASINIER</a></li>
	...
	<!--Content Start-->
	<div class="content-start transition" style="background: rgb(242,242,242);
     ...
     <div class="row">
				<div class="col-md-6 col-lg-3" >
					<div class="card">
						...
						<div class="card-body" style="background: linear-gradient(-45deg, #004362, #0183d0) !important; border: solid; border-color: yellow;  ">
							<div class="row">
	...
	<div class="col-lg-6 col-md-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<p>
				<i style="color: orange;" class="fas fa-chart-line fa-3x"></i></p>
			</center>
...
<div class="col-lg-6 col-md-12">
	<div class="card">
			...
			<div class="card-body">
				...
				<p>
				<i style="color: blue;" class="fas fa-table fa-3x"></i></p>
			</center>
                ...
                <div class="card">
                    <div class="card-body">
                        <center>
                            <h1>RAPPORTS</h1>
                            <p><i style="color: green;" class="fas fa-file-alt fa-3x"></i></p>
                        </center>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <center>
                            <h1>UTILISATEURS</h1>
                            <p><i style="color: red;" class="fas fa-users fa-3x"></i></p>
                        </center>
                    </div>
                </div>
            </div>		
                ...
                <td id="<?php echo $row['id'].'code' ?>" style="vertical-align: middle;"> 	<?php echo  $row['code_ppm_client']; ?> </td>
                 <td id="<?php echo $row['id'].'adresse' ?>" style="vertical-align: middle;"> 	<?php echo  $row['adresse_client']; ?> </td>
                  <td id="<?php echo $row['id'].'tel' ?>" style="vertical-align: middle;"> 	<?php echo  $row['tel_client']; ?> </td>
                   <td id="<?php echo $row['id'].'email' ?>" style="vertical-align: middle;"> 	<?php echo  $row['email_client']; ?> </td>
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
 ...
 <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	...
	<script src="js/navire/afficher.js?=<?php echo time(); ?>"></script>
	<script src="js/categories/afficher.js?=<?php echo time(); ?>"></script>
	<script src="js/camion/afficher.js?=<?php echo time(); ?>"></script>
	<script src="js/chauffeur/afficher.js?=<?php echo time(); ?>"></script>
	<script src="js/transporteur/afficher.js?=<?php echo time(); ?>"></script>
	<script src="js/produit/afficher.js?=<?php echo time(); ?>"></script>
	<script src="js/client/afficher.js?=<?php echo time(); ?>"></script>
    <script src="js/entrepot/afficher.js?=<?php echo time(); ?>"></script>

   <script src="js/navire/ajout.js?=<?php echo time(); ?>"></script>
   <script src="js/navire/ajout_manifeste.js?=<?php echo time(); ?>"></script>
   <script src="js/navire/afficher_form_poids_manifeste.js?=<?php echo time(); ?>"></script>

  <script src="js/produit/ajout.js?=<?php echo time(); ?>"></script>
